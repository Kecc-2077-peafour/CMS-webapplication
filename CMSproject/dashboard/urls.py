...
from .views import s_dashboard_view, student_view, teacher_view, viewmyResult_view ,handle_viewmy_result_submission,addResult_view,viewResult_view,handle_teacher_add_result_submission,handle_teacher_view_result_submission
...
urlpatterns = [
    ...
    path('teacher/addResult', addResult_view, name='teacher_add_result'),
