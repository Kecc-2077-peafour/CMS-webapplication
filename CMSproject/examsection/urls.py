...
from .views.exam import examsection_view, handle_course_Info_submisssion, courseInfo_view,handle_analysis_filter_submission,student_analysis_view
...
urlpatterns =[
    ...
    path('handle_student_analysis_submission/', handle_analysis_filter_submission,name='handle_student_analysis_submission'),
    path('studentanalysis/', student_analysis_view, name='studentanalysis_view'),
